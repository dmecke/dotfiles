# helper
alias disable_a2mods="sudo a2dismod php7.1 php7.2 php7.3 php7.4 php8.0 php8.1 php8.2 php8.3 php8.4"
...
alias use_php84="disable_a2mods && sudo a2enmod php8.4 && restart_apache && sudo update-alternatives --set php /usr/bin/php8.4"
